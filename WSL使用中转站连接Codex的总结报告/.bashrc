...
# 关键：localhost 回调不能被代理劫，否则 OAuth 最后一步又挂

# export no_proxy="localhost,127.0.0.1,::1"
# export NO_PROXY="localhost,127.0.0.1,::1"

export no_proxy="localhost,127.0.0.1,::1,172.22.80.1,nexusacc.itssx.com,nexus.itssx.com,ai.itssx.com"
export NO_PROXY="$no_proxy"

# 让 Node.js undici 库读取环境代理变量
export NODE_USE_ENV_PROXY=1
# 给老版本 Node 的 global-agent 兜底
export GLOBAL_AGENT_HTTP_PROXY="http://172.22.80.1:7897"

# User-level Python tools installed by pip --user.
if [ -d "$HOME/.local/bin" ] && [[ ":$PATH:" != *":$HOME/.local/bin:"* ]]; then
    export PATH="$HOME/.local/bin:$PATH"
fi

export CRS_OAI_KEY="sk-ab45422a38052ca54777c75a1729596546fbcab01cf94e69"
